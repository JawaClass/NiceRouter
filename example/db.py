...
async def seed_db():
    async with AsyncSession(engine) as session:
        ...
        # Create some todos
        todo1 = ToDoItem(name="Buy groceries", creator=alice, done=False)
        todo2 = ToDoItem(name="Finish FastAPI project", creator=alice, done=True)
        todo3 = ToDoItem(name="Call mom", creator=bob, done=False)
