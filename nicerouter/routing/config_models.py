...
# type PostProcessorCallable[OUTPUT_MODEL] = Callable[[OUTPUT_MODEL, AsyncSession], Awaitable[OUTPUT_MODEL]]

# @dataclass
# class RouteConfig[INPUT_MODEL: BaseModel, OUTPUT_MODEL: BaseModel]:
#     input_model: type[INPUT_MODEL]
#     response_model: type[OUTPUT_MODEL] 
#     preprocessor_input: PreProcessorCallable[INPUT_MODEL] | None = None
#     postprocessor_input: PreProcessorCallable[INPUT_MODEL] | None = None
    


# # class GetByIdConfig[OUT: BaseModel](BaseModel):
# #     model_config = ConfigDict(arbitrary_types_allowed=True)
# #     response_model: type[OUT]
...
# # class GetAllConfig[OUT: BaseModel](BaseModel):
# #     model_config = ConfigDict(arbitrary_types_allowed=True)
# #     response_model: type[OUT]
# #     normalizer: ObjectNormalizer | None = None
# #     query: sa.Select | None = None
...
# # class PatchRouteConfig[INPUT_MODEL: BaseModel, OUTPUT_MODEL: BaseModel](BaseModel):
# #     input_model: type[INPUT_MODEL]
# #     response_model: type[OUTPUT_MODEL]
# #     preprocessor_input: PreProcessorCallable[INPUT_MODEL] | None = None
...
# # class CreateRouterConfig[DB: DeclarativeBase](BaseModel):
# #     db_class: type[DB] 
