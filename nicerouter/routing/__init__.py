...
# from nicerouter.routing.service.crud_service import CrudRepository, CrudService
...
# def create_router_for_db[DB: DeclarativeBase](
#     *,
#     prefix: str,
#     get_db_session: Callable[[], AsyncGenerator[AsyncSession, None]],
#     db_class: type[DB] | None = None,
#     service: CrudService[DB, BaseModel]| None = None,
#     # normalizer: ObjectNormalizer | None = None,
# ) -> NiceAPIRouter[DB, BaseModel]:

#     if sum(
#         [bool(db_class), bool(service)]
#     ) > 1:
#         raise ValueError("Provide only one of db_class or service, not both.")

#     if service is None:
#         if db_class is None:
#             raise ValueError("Either db_class or service must be provided.")
...
# type DB_CALLABLE = Callable[[], AsyncGenerator[AsyncSession, None]]


# def create_crud_router[T: DeclarativeBase, DTO: BaseModel](
#     *,
#     prefix: str,
#     get_db_session: DB_CALLABLE,
#     service: CrudService[T, DTO]
# ):
#     fastapi_router = APIRouter(prefix=prefix)
#     nice_router = NiceAPIRouter(router=fastapi_router, service=service)

#     # service.repository.model_cls
#     service.dto_mapper.dto_cls
#     service.dto_mapper.entity_cls
