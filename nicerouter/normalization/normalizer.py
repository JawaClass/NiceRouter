...
class ObjectNormalizer:
    ...
    def _extract_most_inner_type(self, model: type[BaseModel], field_name: str):
         ...
         if field_info is None:
              raise ValueError(f"{model=}:{field_info=}. field_info was None. Not sure how to handle this.")
         annotation = field_info.annotation
         if annotation is None:
              raise ValueError(f"{model=}:{field_info=}. annotation was None. Not sure how to handle this.")
    ...
    def _get_model_metadata(self, model_type: type[BaseModel]):
        ...
        standard = set(model_fields.keys()) - set(reference_fields.keys()) - set(list_fields.keys())
    ...
    def normalize(
            ...
            *,
            ...
            reference_fields, list_fields, standard_fields = self._get_model_metadata(obj_model)
            ...
            for field_name in reference_fields:
                ...
                normalized_child = self.normalize(obj=ref_field_obj, obj_model=ref_field_obj_model, id_name=id_name)
            ...
            for field_name in list_fields: 
                ...
                normalized_obj[field_name] = [
                    self.normalize(obj=o, obj_model=ref_field_obj_model)[id_name] for o in getattr(obj, field_name)
                ]
